...
const concertFactory = (searchCriteria) => {
    concert_id ++;
    ...
    // Change this
    card.textContent = searchResults;
...
// Delete or comment this after testing
const searchCriteria = "ZZ Top";
const searchResultPromise = apiConcertManager.searchConcerts(searchCriteria);
searchResultPromise.then(searchResults => {
  concertFactory(searchResults);
});